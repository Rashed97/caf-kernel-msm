...
static int hscd_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
    ...
    dev_info(&client->adapter->dev, "detected HSCDTD004/006 geomagnetic field sensor\n");
...
EXPORT_SYMBOL(hscd_get_hardware_data);
