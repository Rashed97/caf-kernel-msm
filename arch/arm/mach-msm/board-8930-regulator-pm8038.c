...
VREG_CONSUMERS(L9) = {
	...
	REGULATOR_SUPPLY("hscd_vdd",		"12-000c"),
...
VREG_CONSUMERS(L12) = {
	...
	REGULATOR_SUPPLY("dsi_lvds_vddc",		"mipi_dsi.1"),
...
VREG_CONSUMERS(LVS1) = {
	...
	REGULATOR_SUPPLY("ts_i2c",		"3-0020"),
...
VREG_CONSUMERS(LVS2) = {
	...
	REGULATOR_SUPPLY("vcc_i2c",		    "12-0018"),
	REGULATOR_SUPPLY("vcc_i2c",		    "12-000c"),
};
